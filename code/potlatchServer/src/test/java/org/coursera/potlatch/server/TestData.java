package org.coursera.potlatch.server;
...
public class TestData {
	 ...
	 * @return
	 */
	public static GiftBean randomGift() {
		// Information about the video
		// Construct a random identifier using Java's UUID class
		String id = UUID.randomUUID().toString();
		String title = "Gift-" + id;
		String description = "Text for gift " + id;
		String url = "http://store.bischof.us/potlatch/gift-" + id;
		return new GiftBean(title, description, url);
	}
